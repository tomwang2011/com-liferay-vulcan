...
import static com.liferay.vulcan.writer.url.URLCreator.createRelatedCollectionURL;
...
public class URLCreatorTest {
	...
	@Test
	public void testCreateRelatedCollectionURL() {
		String url = createRelatedCollectionURL(_serverURL, _path, "related");
